...
applyTo: "src/ravi/core/tools/**,src/ravi/tools/**"
---

# Tool Authoring Rules

## Every tool MUST:
1. Subclass `BaseTool` from `agent_substratecore.tools.base_tool`.
...
`MCPTool` (from `agent_substrateintegrations.mcp`) exposes three schema formats:
```python
