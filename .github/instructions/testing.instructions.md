...
```python
from agent_substratecore.tools.base_tool import BaseTool, ToolResult
...
async def test_agent_run():
    with patch("agent_substrateintegrations.llm.openai.openai_client.OpenAIClient") as mock:
