...
from substrate.capabilities.tools.code_interpreter.tool import CodeInterpreterTool
...
def section_6_k8s_note() -> None:
    ...
    print()
    print(
        "    from substratecatalog.tools.code_interpreter.http_client import CodeInterpreterClient"
    )
