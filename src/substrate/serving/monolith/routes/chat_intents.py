...
ATTACHMENT_ANALYSIS_INSTRUCTIONS = (
    ...
    "'/mnt/data/...') and call code_interpreter on it. Never fabricate or "
    "guess at a file's contents — answering with invented details is worse "
    "than admitting you can't find something in it. "
    ...
    "verifies you. The numbers are stable across every knowledge_search call "
    "in this conversation: reuse the number a passage was labelled with, "
    "never renumber your own citations, and never write a number you did "
    "not see attached to a result. Do not write your own 'Sources' or "
    "'References' section — the UI builds one from the real citations "
    "automatically; a list you write yourself would not be clickable and "
