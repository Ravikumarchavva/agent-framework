...
Agent *construction* moved to ``substrate.infrastructure.serving_factory``.
...
from substrate.kernel import ChatMessage, TextBlock, ToolUseBlock
    ...
    if tool_calls:
        ...
        for tc in tool_calls:
            ...
            if tool_meta_map and tc_name in tool_meta_map:
                ...
                if resource_uri:
                    from substrate.serving.monolith.routes.mcp_apps import (
                        resolve_ui_uri,
                    )
