"""AgentContext — first-class context manager orchestrator."""
...
class AgentContext:
    ...
    AgentContext is the container and orchestrator. It holds a backing HistoryProvider
    ...
    def __repr__(self) -> str:
        return f"<AgentContext(history={self.history!r}, strategies={self.compaction_strategies})>"
