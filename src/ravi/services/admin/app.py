...
Entry point: uvicorn ravi.services.admin.app:app --port 8019
"""
...
from ravi.services.admin.models import ServiceBase
from ravi.services.admin.routes import router
