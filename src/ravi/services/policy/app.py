...
Entry point: uvicorn ravi.services.policy.app:app --port 8011
"""
...
from ravi.services.policy.routes import router
from ravi.shared.database.base import ServiceBase

import ravi.services.policy.models  # noqa: F401 — register ORM models before create_all
