...
def generate_code(config: PipelineConfig) -> str:
    ...
    if NodeType.GUARDRAIL in node_types_used:
        sections.append(
            ...
            from ravi.kernel.structured.schemas import ContentSafetyJudge, RelevanceJudge
        """)
        )
...
_TOOL_IMPORT_MAP = {
    "calculator": "from ravi.extensions.tools.builtin_tools import CalculatorTool",
    "get_current_time": "from ravi.extensions.tools.builtin_tools import GetCurrentTimeTool",
