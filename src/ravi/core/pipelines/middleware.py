...
This module is intentionally separate from ``ravi.core.middleware``.

- ``ravi.core.middleware`` applies to individual agent internals such as
  one LLM call or one tool execution.
- ``ravi.core.pipelines.middleware`` applies to the workflow as a whole:
