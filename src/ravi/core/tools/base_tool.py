...
logger = logging.getLogger("ravi.tools")
...
class BaseTool(ABC):
    ...
    def __init__(
        ...
        self.risk: ToolRisk = risk if risk is not ToolRisk.SAFE else type(self).risk  # type: ignore[misc]
        # HITL mode: instance overrides class default if explicitly provided
        self.hitl_mode: HitlMode = (  # type: ignore[misc]
