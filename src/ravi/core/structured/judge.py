...
class LLMJudge(BaseGuardrail):
    ...
    Example::
        ...
        from ravi.core.structured import LLMJudge, ContentSafetyJudge
    ...
    async def check(self, ctx: GuardrailContext) -> GuardrailResult:
        ...
        try:
            ...
            logger.error(
                "[%s] structured generate failed: %s", self.name, exc, exc_info=True
            )
