...
This module is intentionally separate from ``ravi.kernel.middleware``.

- ``ravi.kernel.middleware`` applies to individual agent internals such as
  one LLM call or one tool execution.
- ``ravi.orchestration.workflows.middleware`` applies to the workflow as a whole:
