...
async def handle_stream_final_response(
    *,
    ...
    if response_schema is not None:
        from ravi.agents.assistant._legacy_stubs import StructuredOutputChunk

        _parsed = getattr(response, "parsed", None)
        if _parsed is not None:
            from ravi.agents.assistant._legacy_stubs import StructuredOutputResult
            ...
            from ravi.agents.assistant._legacy_stubs import StructuredOutputResult as _SOR
