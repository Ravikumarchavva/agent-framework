...
Quick start::
    ...
    from ravi.platform.evals import (
...
from ravi.platform.evals.models import (
    EvalCase,
    EvalDataset,
    EvalScore,
    EvalCaseResult,
...
from ravi.platform.evals.criteria import (
    EvalCriterion,
    CORRECTNESS,
    HELPFULNESS,
    RELEVANCE,
...
from ravi.platform.evals.judge import LLMJudge
from ravi.platform.evals.runner import EvalRunner
