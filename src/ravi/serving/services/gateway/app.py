...
Entry point: uvicorn ravi.serving.services.gateway.app:app --port 8001
...
from ravi.serving.services.gateway.clients import (
    ArtifactClient,
...
from ravi.serving.services.gateway.routes import (
    auth_router,
    chat_router,
    execute_router,
    file_router,
