...
Entry point: uvicorn ravi.serving.services.policy.app:app --port 8011
"""
...
from ravi.serving.services.policy.routes import router
from ravi.serving.shared.database.base import ServiceBase

import ravi.serving.services.policy.models  # noqa: F401 — register ORM models before create_all
...
async def lifespan(app):
    ...
    async with session_factory() as db:
        from ravi.serving.services.policy.service import seed_default_policies
