...
from ravi.serving.shared.auth.middleware import get_current_user
from ravi.serving.shared.auth import jwt as jwt_utils
from ravi.serving.shared.contracts.auth import (
    AgentTokenRequest,
    AgentTokenResponse,
    RefreshRequest,
...
async def exchange_token(body: TokenExchangeRequest, request: Request):
    ...
    from ravi.serving.services.identity.service import exchange_frontend_token
