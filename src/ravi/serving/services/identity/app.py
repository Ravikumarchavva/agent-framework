...
Entry point: uvicorn ravi.serving.services.identity.app:app --port 8010
"""
...
from ravi.serving.services.identity.routes import router
from ravi.serving.shared.database.base import ServiceBase
from ravi.serving.shared.events.factory import get_event_bus

import ravi.serving.services.identity.models  # noqa: F401 — register ORM models before create_all
