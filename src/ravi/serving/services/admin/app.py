...
Entry point: uvicorn ravi.serving.services.admin.app:app --port 8019
"""
...
from ravi.serving.services.admin.models import ServiceBase
from ravi.serving.services.admin.routes import router
