...
Entry point: uvicorn ravi.serving.services.conversation.app:app --port 8012
"""
...
from ravi.serving.services.conversation.models import ServiceBase
from ravi.serving.services.conversation.routes import memory_router, thread_router
