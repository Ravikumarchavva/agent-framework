"""Default framework-native agent — zero-config entry point for raavan.
...
from raavan.core.context import SlidingWindowContext
...
class Agent:
    """Framework-native agent — the simplest way to use raavan.
