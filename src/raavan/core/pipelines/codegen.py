...
The generated file is self-contained: it imports from ``raavan``,
...
def generate_code(config: PipelineConfig) -> str:
    ...
    if NodeType.GUARDRAIL in node_types_used:
        sections.append(
            ...
            from raavan.core.structured.schemas import ContentSafetyJudge, RelevanceJudge
        """)
        )
...
_TOOL_IMPORT_MAP = {
    "calculator": "from raavan.core.tools.builtin_tools import CalculatorTool",
    "get_current_time": "from raavan.core.tools.builtin_tools import GetCurrentTimeTool",
    "data_visualizer": "from raavan.integrations.mcp.app_tools import DataVisualizerTool",
    "markdown_previewer": "from raavan.integrations.mcp.app_tools import MarkdownPreviewerTool",
    "json_explorer": "from raavan.integrations.mcp.app_tools import JsonExplorerTool",
    "color_palette": "from raavan.integrations.mcp.app_tools import ColorPaletteTool",
    "kanban_board": "from raavan.integrations.mcp.app_tools import KanbanBoardTool",
    "spotify_player": "from raavan.integrations.mcp.app_tools import SpotifyPlayerTool",
}
