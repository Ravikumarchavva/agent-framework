...
from agent_substrate.serving.shared.auth.middleware import get_current_user
from agent_substrate.serving.shared.auth import jwt as jwt_utils
from agent_substrate.serving.shared.contracts.auth import (
    AgentTokenRequest,
    AgentTokenResponse,
    RefreshRequest,
...
async def exchange_token(body: TokenExchangeRequest, request: Request):
    ...
    from agent_substrate.serving.services.identity.service import exchange_frontend_token
