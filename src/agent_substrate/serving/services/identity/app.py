...
Entry point: uvicorn agent_substrate.serving.services.identity.app:app --port 8010
"""
...
from agent_substrate.serving.services.identity.routes import router
...
import agent_substrate.serving.services.identity.models  # noqa: F401 — register ORM models before create_all
