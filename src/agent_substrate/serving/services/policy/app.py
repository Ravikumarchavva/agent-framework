...
Entry point: uvicorn agent_substrate.serving.services.policy.app:app --port 8011
"""
...
from agent_substrate.serving.services.base import create_service_app, init_service_db
from agent_substrate.serving.services.policy.routes import router
from agent_substrate.serving.shared.database.base import ServiceBase

import agent_substrate.serving.services.policy.models  # noqa: F401 — register ORM models before create_all
...
async def lifespan(app):
    ...
    async with session_factory() as db:
        from agent_substrate.serving.services.policy.service import seed_default_policies
