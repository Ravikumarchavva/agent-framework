...
Entry point: uvicorn agent_substrate.serving.services.gateway.app:app --port 8001
...
from agent_substrate.serving.services.gateway.clients import (
    ArtifactClient,
...
from agent_substrate.serving.services.gateway.routes import (
    auth_router,
    chat_router,
    execute_router,
    file_router,
