...
from agent_substrate.infrastructure.serving_factory import build_agent_for_thread, build_chat_tools
...
from agent_substrate.capabilities.tools.task_manager.tool import current_thread_id
from agent_substrate.kernel import ChatMessage
from agent_substrate.kernel.core.content import TextBlock, ToolUseBlock
from agent_substrate.kernel.core.content import (
    ChatMessage as _ChatMessage,
    Role,
    TextBlock as _TextBlock,
)
from agent_substrate.kernel.core.identity import AgentId as _AgentId
from agent_substrate.kernel.messaging.message import (
    ChatPayload as _ChatPayload,
    Message as _Message,
)
from agent_substrate.serving.monolith.dependencies import ServerDependencies, get_ctx
from agent_substrate.serving.monolith.database import get_db
from agent_substrate.serving.monolith.hooks import ChatContext, hooks
from agent_substrate.serving.monolith.schemas import ChatRequest
from agent_substrate.serving.monolith.services import get_thread
from agent_substrate.serving.monolith.services.agent_service import (
...
from agent_substrate.serving.shared.rate_limit import rate_limit
from agent_substrate.serving.protocol import (
    PROTOCOL_VERSION,
    TurnCompletedEvent,
    ToolResultEvent,
)
from agent_substrate.serving.stream import AgentStreamSession
...
async def _build_file_context(
    ...
    from agent_substrate.serving.monolith.models import FileMetadata
