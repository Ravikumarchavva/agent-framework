...
tools can access it without a round-trip back to agent_substrate
...
from agent_substrate.serving.monolith.security.deps import AuthClaims, get_current_user
