...
Provider / model / cost table lives in ``agent_substrate.kernel.llm.models``.
    ...
    def build(
        ...
        **kwargs: Any,
        ...
        if self._provider in _CHAT_COMPLETIONS_PROVIDERS:
            from agent_substrate.capabilities.llm.chat_client import (
        ...
        if self._provider == "anthropic":
            from agent_substrate.integrations.llm.anthropic.anthropic_client import AnthropicClient
        ...
        if self._provider == "gemini":
            from agent_substrate.integrations.llm.gemini.gemini_client import GeminiClient
...
def create_embedding_client(
    ...
    *,
    ...
    if provider == "openai":
        from agent_substrate.integrations.llm.openai.openai_embedding_client import (
    ...
    if provider == "gemini":
        from agent_substrate.integrations.llm.gemini.gemini_embedding_client import (
