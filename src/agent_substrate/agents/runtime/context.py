...
from agent_substrate.kernel.agent.runtime_context import RunMeta
from agent_substrate.kernel.core.content import ContentBlock, JsonObject, content_block_from_dict
from agent_substrate.kernel.core.identity import AgentId, TopicId
from agent_substrate.kernel.core.usage import Usage
from agent_substrate.kernel.llm.llm import GenerationOptions, LLMResponse
...
from agent_substrate.kernel.tools.chain import InvocationResult
...
if TYPE_CHECKING:
    ...
    from agent_substrate.kernel.llm.llm import LLMClient
    ...
    from agent_substrate.kernel.runtime.agent import Agent
    from agent_substrate.agents.tools.invoker import InvokerSession, ToolInvoker
