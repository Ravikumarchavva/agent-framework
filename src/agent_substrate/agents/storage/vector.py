...
A dependency-free :class:`~agent_substrate.kernel.storage.vector.VectorStore` implementation
...
Usage::
    ...
    from agent_substrate.agents.storage import InMemoryVectorStore
