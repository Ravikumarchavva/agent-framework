...
if TYPE_CHECKING:
    ...
    from agent_substrate.kernel.storage.graph import GraphStore
...
class GraphRAGPipeline:
    ...
    async def query(
        ...
        *,
        ...
        from agent_substrate.kernel.storage.graph import CypherCapable
                        ...
                        if isinstance(val, str):
                            try:
                                ...
                                if any(kw in name for kw in keywords):
                                    from agent_substrate.kernel.storage.graph import Entity
