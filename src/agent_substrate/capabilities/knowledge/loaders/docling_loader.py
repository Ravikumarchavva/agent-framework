...
from agent_substrate.capabilities.knowledge.loaders.base import BaseDocumentLoader
from agent_substrate.kernel.core.content import CodeBlock, DataBlock, ImageBlock, TextBlock
from agent_substrate.kernel.storage.vector import Document
from agent_substrate.logger import setup_logging

logger = setup_logging("agent_substrate.capabilities.knowledge.loaders.docling")
